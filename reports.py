...
if __name__ == '__main__':
    ...
    parser.add_argument('--voc_list',
                        default="20H (Beta, V2);20I (Alpha, V1);20J (Gamma, V3);21A (Delta)",
                        help='Semicolon separated list of Nextclade Clades that are official Variants of Concern. (default: %(default)s)')
    parser.add_argument('--voi_list',
                        default="21B (Kappa);21C (Epsilon);21D (Eta);21E (Theta);21F (Iota);21G (Lambda);21H (Mu)",
                        help='Semicolon separated list of Nextclade Clades that are official Variants of Interest. (default: %(default)s)')
