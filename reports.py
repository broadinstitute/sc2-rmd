...
if __name__ == '__main__':
    ...
    parser.add_argument('--voc_list',
                        default="B.1.1.7,Q.1,Q.2,Q.3,B.1.351,B.1.351.1,B.1.351.2,B.1.351.3,P.1,P.1.1,P.1.2,P.1.3,P.1.4,P.1.5,P.1.6,P.1.7,P.1.8,P.1.9,P.1.10,B.1.617.2,AY.1,AY.2,AY.3,AY.3.1,AY.4,AY.5,AY.6,AY.7,AY.7.1,AY.7.2,AY.8,AY.9,AY.10,AY.11,AY.12",
